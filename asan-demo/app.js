// App State
let balance = parseFloat(localStorage.getItem('asan_balance')) || 500000;
let history = JSON.parse(localStorage.getItem('asan_history')) || [
...
let currentPin = '';
let isTechnicalLocked = localStorage.getItem('asan_locked') === 'true';
        ...
        if (currentPin.length === 4) {
            setTimeout(() => {
                if (currentPin === '5555') {
                    ...
                    localStorage.setItem('asan_locked', 'false');
...
function triggerTechnicalWorks() {
    ...
    localStorage.setItem('asan_locked', 'true');
...
function updateUI() {
    ...
    renderHistory();
    localStorage.setItem('asan_balance', balance);
    localStorage.setItem('asan_history', JSON.stringify(history));
}
